...
urlpatterns = [
                  ...
                  path('pred_bid/', views.pred_bid, name='shop'),
                  ...
                  path('vegetableSelectProducer/<str:id>', views.vegetableSelectProducer,
                       name='vegetableSelectProducer'),
                  ...
                  path('itemtest/', views.Itemtest.as_view(), name='itemtest'),
